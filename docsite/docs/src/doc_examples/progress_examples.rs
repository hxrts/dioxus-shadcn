...
pub mod basic {
    // ANCHOR: basic
    use dioxus::prelude::*;
    use dioxus_shadcn::components::progress::Progress;
...
pub mod sizes {
    // ANCHOR: sizes
    use dioxus::prelude::*;
    use dioxus_shadcn::components::progress::{Progress, ProgressSize};
...
pub mod variants {
    // ANCHOR: variants
    use dioxus::prelude::*;
    use dioxus_shadcn::components::progress::{Progress, ProgressVariant};
